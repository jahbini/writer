...
@step =
  ...
  action: (S) ->
    ...
    if pending.length is 0
      # Local override: oracle exhausted is a no-op, not a pipeline shutdown.
      # full_cycle_ite still needs lora_ite + diary_ite + eval_ite to run.
      console.log "[oracle_ask_sqlite] all stories already oracled; no-op"
